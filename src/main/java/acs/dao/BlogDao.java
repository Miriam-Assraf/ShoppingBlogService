...
//    Flux<BlogPost> findAll(Pageable page);
    Flux<BlogPost> findAllByPostingTimeStampAfter(Sort by, @Param("fromDate") Date fromDate);

    // find all by user
    Flux<BlogPost> findAllByUser_Email(Sort by, @Param("email") String email);
    Flux<BlogPost> findAllByUser_Email_AndPostingTimeStampAfter(Sort by, @Param("email") String email, @Param("fromDate") Date fromDate);
    ...
    Flux<BlogPost> findAllByProduct_Id_AndPostingTimeStampAfter(Sort by, @Param("productId") String productId, @Param("fromDate") Date fromDate);
